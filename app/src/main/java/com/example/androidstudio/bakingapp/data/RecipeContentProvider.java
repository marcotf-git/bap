...
public class RecipeContentProvider extends ContentProvider {
    ...
    /**
     This class defines a static buildUriMatcher method that associates URI's with their int match
     Initializes a new matcher object without any matches,
     then uses .addURI(String authority, String path, int match) to add matches
     */
